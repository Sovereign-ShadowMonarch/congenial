        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="h-75">
                The aim of this web application is to deliver a
                cryptocurrency trading experience. We strive to complete our engineering with this amazing major project.
                <br></br>
                <br></br>
                ...
                <br></br>
                <br></br>
                <b className="text-primary">Chakradharishiva</b>,{" "}
                <b className="text-primary">Varaprasad</b> and{" "}
                <b className="text-primary">Adithya K</b>
              </div>
            </div>
          </Col>
        </Row>
