...
from rotkehlchen.history.events import EventsHistorian, FREE_LEDGER_ACTIONS_LIMIT
...
class Rotkehlchen():
    ...
    def _apply_actions_limit(
        ...
        """Adds actions from location_actions to all_actions up to the limit.

        Returns the modified all_actions.
        """
